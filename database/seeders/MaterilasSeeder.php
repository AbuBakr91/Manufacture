...
class MaterilasSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i=0;$i<count($result); $i++) {
            $results[] = json_decode(Http::withBasicAuth(env('M_LOGIN'), env('M_PASS'))->get('https://online.moysklad.ru/api/remap/1.2/entity/processingplan/'.$result[$i]->tech_id.'/materials'));
        }
