...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i=0;$i<count($result); $i++) {
            $results[] = json_decode(Http::withBasicAuth('multishop@4wimax', '3hQ&ue1x')->get('https://online.moysklad.ru/api/remap/1.2/entity/processingplan/'.$result[$i]->tech_id.'/products'));
        }
