...
//SELECT technical_cards.name, performing_tasks.count, performing_tasks.defects, users.firstname, users.lastname FROM performing_tasks
//join users
//ON performing_tasks.user_id = users.id
//JOIN task_orders
//ON task_orders.id = performing_tasks.task_id
//JOIN technical_cards
//ON technical_cards.id = task_orders.card_id
